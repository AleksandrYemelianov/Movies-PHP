<?php
/**
 * @var \App\Models\MovieModel $movie
...
<tr>
    <td style="width: 200px;">
        <img width="50" src="<?php echo $storage->uri($movie->getPreview()) ?>" alt="<?php echo $movie->getName() ?>">
    </td>
    ...
    <td>
        <div class="dropdown d-flex justify-content-end">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a class="dropdown-item" href="/admin/categories/update?id=<?php echo $movie->getId()?>">
